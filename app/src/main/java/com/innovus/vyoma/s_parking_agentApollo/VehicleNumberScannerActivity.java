...
import utilities.camera.CameraSource;
import utilities.camera.CameraSourcePreview;
import utilities.camera.GraphicOverlay;
import utilities.numberPlateScanner.OcrDetectorProcessor;
import utilities.numberPlateScanner.OcrGraphic;

public class VehicleNumberScannerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vehicle_number_scanner);
