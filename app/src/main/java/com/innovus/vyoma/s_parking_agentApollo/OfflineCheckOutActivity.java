...
public class OfflineCheckOutActivity extends AppCompatActivity
        implements View.OnClickListener, /* SwipeListener, *//* DecoratedBarcodeView.TorchListener, */ AsyncResponse,
    ...
    private RadioButton radioButton_specialpass, radioButton_monthlypass, radioButton_twowheel, radioButton_fourwheel,
            radioButton_none;
    ...
    String agencyNameOnly = "", enterpriseNameOnly = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String AgencyName = SharedStorage.getValue(getApplicationContext(), "AgencyName");
        if (AgencyName != null && AgencyName.contains("|")) {
            String[] parts = AgencyName.split("\\|");
            agencyNameOnly = parts[0].trim();
            enterpriseNameOnly = parts[1].trim();
        } else {
            agencyNameOnly = AgencyName;
            enterpriseNameOnly = "Rohini Enterprise"; // Fallback
        }
        ...
        if (type.equals(RemoteAsync.BBCTRL)) {
            ...
            try {
                ...
                if (obj.getString("status").equals(Constants.SUCCESS)) {
                    ...
                    // ShowAlertDialog.showAlertDialog(OfflineCheckOutActivity.this,
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.btn_endParking) {
            ...
            if (validate()) {
                ...
                try {
                    if (isExistInOfflineAndOnlineTable(m_EditText_VehicleNumber.getText().toString())
                            || isAlreadyCheckedOutorNot(m_EditText_VehicleNumber.getText().toString())) {
                        ...
                        if (isexistindatabase()) {// if database is exist
                            ...
                            newbookingbillbean = filtermodel_bookingtableobject(
                                    dataModel.offlinebookingBillBeansnArrayList,
                                    et_bookingid.getText().toString().trim());
                            ...
                            bookingBillBean = new BookingBillBean(newbookingbillbean.getBookingno(),
                                    ...
                                    newbookingbillbean.getParkingAreaName(),
                                    newbookingbillbean.getTotalDuration(), String.valueOf(parkingarea_fee),
                                    String.valueOf(total_parkingarea_fee),
                                    newbookingbillbean.getFineAmount(), newbookingbillbean.getOfferAmount(),
                            ...
                            checkintime = et_checkinDate.getText().toString().trim() + " "
                                    + et_checkinTime.getText().toString().trim();

                            Date date1 = null;
                            try {
                                date1 = simpleDateFormat.parse(et_checkinDate.getText().toString().trim() + " "
                                        + et_checkinTime.getText().toString().trim());
                            } catch (ParseException e) {
                                e.printStackTrace();
                            }
                                ...
                                if (paymode == 4) {// for special pass
                                    ...
                                    if (iVehicleType == 1) {// two wheeler
                                        ...
                                        if (hours > vehicleminduration_inhour) {
                                            ...
                                            recursive = Integer.valueOf(
                                                    dataModel.vehicleTypePriceArrayList.get(0).getRecursiveDuration());
                                            ...
                                            firstcahnrge = Integer.valueOf(
                                                    dataModel.vehicleTypePriceArrayList.get(0).getFirstCharge());
                                            parkingrate = Integer.valueOf(
                                                    dataModel.vehicleTypePriceArrayList.get(0).getHourlyCharge());
                                            parkingarea_fee = firstcahnrge
                                                    + (((hours - vehicleminduration_inhour) / RecursiveDuration)
                                                            * parkingrate);
                                        ...
                                        if (hours > vehicleminduration_inhour) {
                                            ...
                                            int RecursiveDuration = 0;
                                            recursive = Integer.valueOf(
                                                    dataModel.vehicleTypePriceArrayList.get(1).getRecursiveDuration());
                                            RecursiveDuration = (recursive / 60);
                                            if (RecursiveDuration != 1) {
                                                if (RecursiveDuration % (60) != 0.0) {
                                            ...
                                            firstcahnrge = Integer.valueOf(
                                                    dataModel.vehicleTypePriceArrayList.get(1).getFirstCharge());

                                            Log.e("firstcahnrge", String.valueOf(firstcahnrge));
                                            parkingrate = Integer.valueOf(
                                                    dataModel.vehicleTypePriceArrayList.get(1).getHourlyCharge());
                                            parkingarea_fee = firstcahnrge
                                                    + (((hours - vehicleminduration_inhour) / RecursiveDuration)
                                                            * parkingrate);
                                        ...
                                        if (hours > vehicleminduration_inhour) {
                                            ...
                                            int RecursiveDuration = 0;
                                            recursive = Integer.valueOf(
                                                    dataModel.vehicleTypePriceArrayList.get(2).getRecursiveDuration());
                                            RecursiveDuration = (recursive / 60);
                                            ...
                                            firstcahnrge = Integer.valueOf(
                                                    dataModel.vehicleTypePriceArrayList.get(2).getFirstCharge());
                                            parkingrate = Integer.valueOf(
                                                    dataModel.vehicleTypePriceArrayList.get(2).getHourlyCharge());
                                            parkingarea_fee = firstcahnrge
                                                    + (((hours - vehicleminduration_inhour) / RecursiveDuration)
                                                            * parkingrate);
                            ...
                            // set parkingarea_fee for normal agent
                                ...
                                if (paymode == 4) {// for special pass
                                    ...
                                    if (iVehicleType == 1) {// two wheeler
                                        ...
                                        parkingrate = Integer.valueOf(
                                                SharedStorage.getValue(OfflineCheckOutActivity.this, "TwoWheelerRate"));
                                        ...
                                        parkingrate = Integer.valueOf(SharedStorage
                                                .getValue(OfflineCheckOutActivity.this, "FourWheelerRate"));
                                        ...
                                        parkingrate = Integer.valueOf(SharedStorage
                                                .getValue(OfflineCheckOutActivity.this, "HeavyVehicleRate"));
                            ...
                            if (SharedStorage.getValue(getApplicationContext(), "FreeParkingFacility").equals("1")) {
                                ...
                                bookingBillBean = new BookingBillBean(et_bookingid.getText().toString(),
                                        ...
                                        ownermobilenumber, String.valueOf(iVehicleType),
                                        m_EditText_VehicleNumber.getText().toString(),
                            ...
                            // set updated parking fee values to bean class for normal agent
                                ...
                                bookingBillBean = new BookingBillBean(et_bookingid.getText().toString(),
                                        et_bookingid.getText().toString(),
                                        checkintime, checkouttime,
                                        ownermobilenumber, String.valueOf(iVehicleType),
                                        m_EditText_VehicleNumber.getText().toString(),
                                        SharedStorage.getValue(getApplicationContext(), "parkingslot"), Total_duration,
                                        parkingfee, String.valueOf(total_parkingarea_fee), "0", "0",
                                        String.valueOf(paymode),
                                        SharedStorage.getValue(getApplicationContext(), "AgencyName"),
                                        "0", "0", "Sucessfully checked out", advbookingid);
                            }
                        ...
                        if (SharedStorage.getValue(OfflineCheckOutActivity.this, "printer_name").equals("")) {
                            ...
                            bt_cancel.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    alertDialog.dismiss();
                                    try {
                                        Intent intent = new Intent(OfflineCheckOutActivity.this,
                                                OfflineCheckOutActivity.class);
                                        startActivity(intent);
                                    ...
                                    try {
                                        ...
                                        if (isexistindatabase()) {
                                            ...
                                            databaseHandler.updatevehiclecheckofflinecheckoutvechicle(checkintime,
                                                    ...
                                                    m_EditText_VehicleNumber.getText().toString().trim(),
                                                    bookingBillBean.getBookingID());
                                            databaseHandler.updateofflinevehiclecheckinNotsync("2",
                                                    m_EditText_VehicleNumber.getText().toString().trim());
                                            deleteofflinefile("2");
                                            databaseHandler.updateOnlineOfflineTable("2",
                                                    m_EditText_VehicleNumber.getText().toString().trim());
                                            deleteofflineAndOnlinefile(
                                                    m_EditText_VehicleNumber.getText().toString().trim());
                                        } else {
                                        ...
                                        if (SharedStorage.getValue(getApplicationContext(), "FreeParkingFacility")
                                            ...
                                            try {
                                                ...
                                                Intent intent = new Intent(OfflineCheckOutActivity.this,
                                                        OfflineCheckOutActivity.class);
                                                startActivity(intent);
                                                overridePendingTransition(R.anim.trans_stay_back,
                                                        R.anim.trans_stay_back);
                                                finish();
                                            }
                                        } else {
                                            // print slip
                        ...
                        } else if (SharedStorage.getValue(OfflineCheckOutActivity.this, "printer_name")
                                .equals("verifone")) {
                        ...
                        ShowAlertDialog.showAlertDialog(this,
                                "This Vehicle is Currently not checked In in this parking Area.");
    ...
    private boolean validate() {
        ...
        if (et_bookingid.getText().toString().equals("")) {
            ...
            ShowAlertDialog.showAlertDialog(OfflineCheckOutActivity.this,
                    getResources().getString(R.string.booking_vid));
            result = false;
            return result;
            ...
            if (et_acess_control.getText().toString().equals("")) {
                ShowAlertDialog.showAlertDialog(OfflineCheckOutActivity.this,
                        getResources().getString(R.string.acess_vamount));
                result = false;
    ...
    private boolean isexistindatabase() {
        ...
        if (dataModel.offlinebookingBillBeansnArrayList.size() > 0) {
            if (filtermodel_bookingtable(dataModel.offlinebookingBillBeansnArrayList, et_bookingid.getText().toString())
                    .size() == 0) {
                result = false;
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            ...
            case DATE_PICKER_ID_CASE:
                ...
                timePickerDialog = new TimePickerDialog(OfflineCheckOutActivity.this,
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                PrinterTester.getInstance().printStr("Duration     : " + bookingBillBean.getTotalDuration() + "\n",
                        null);
                // PrinterTester.getInstance().printStr("Amount : " + "Rs.
                // "+bookingBillBean.getTotalParkingAmount()+"\n",null);
                //
                // PrinterTester.getInstance().printStr("Fine Amount : " + "Rs.
                // "+bookingBillBean.getFineAmount()+"\n",null);
                // PrinterTester.getInstance().printStr("Discount : " + "Rs.
                // "+bookingBillBean.getOfferAmount()+"\n",null);
                PrinterTester.getInstance().printStr("--------------------------------" + "\n", null);

                PrinterTester.getInstance().fontSet(EFontTypeAscii.FONT_16_32, EFontTypeExtCode.FONT_16_16);
                PrinterTester.getInstance().printStr(
                        "Pay " + "CASH" + "    " + "Rs. " + bookingBillBean.getTotalPaybleAmount() + "\n", null);

                // if (bookingBillBean.getPaymentMode().equals("1")) {
                // PrinterTester.getInstance().printStr("Pay "+"Cash"+" " + "Rs.
                // "+bookingBillBean.getTotalPaybleAmount()+"\n",null);
                //
                // } else if (bookingBillBean.getPaymentMode().equals("4")) {
                // PrinterTester.getInstance().printStr("Pay
                // "+getResources().getString(R.string.special_pass)+" " + "Rs.
                // "+bookingBillBean.getTotalPaybleAmount()+"\n",null);
                //
                // } else if (bookingBillBean.getPaymentMode().equals("3")) {
                // PrinterTester.getInstance().printStr("Pay
                // "+getResources().getString(R.string.normal_pass)+" " + "Rs.
                // "+bookingBillBean.getTotalPaybleAmount()+"\n",null);
                //
                // }
                PrinterTester.getInstance().fontSet(EFontTypeAscii.FONT_8_32, EFontTypeExtCode.FONT_16_16);
                print_bill = new StringBuilder();
                print_bill.append(paddingCenter("Inclusive of GST @ 18%", PAGE_WIDTH_TWO_INCH_SMALL_BOTTOM))
                        .append("\n");
                PrinterTester.getInstance().printStr(String.valueOf(print_bill), null);
                ...
                if (SharedStorage.getValue(getApplicationContext(), "FreeParkingFacility").equals("1")) {
                    ...
                    print_bill = new StringBuilder();
                    print_bill.append(paddingCenter(agencyNameOnly, PAGE_WIDTH_TWO_INCH_SMALL_BOTTOM))
                            .append("\n");
                    print_bill.append(paddingCenter(
                            "GSTIN:" + SharedStorage.getValue(OfflineCheckOutActivity.this, "AgencyGSTNo"),
                            PAGE_WIDTH_TWO_INCH_SMALL_BOTTOM)).append("\n");
                    PrinterTester.getInstance().printStr(String.valueOf(print_bill), null);
                    ...
                    print_bill.append(paddingCenter(
                            "GSTIN:" + SharedStorage.getValue(OfflineCheckOutActivity.this, "AgencyGSTNo"),
                            PAGE_WIDTH_TWO_INCH_SMALL_BOTTOM)).append("\n");
                    print_bill.append(paddingCenter("Thank You. Please visit again!", PAGE_WIDTH_TWO_INCH_SMALL_BOTTOM))
                            .append("\n");
                    print_bill.append(paddingCenter("www.smartpower.co.in", PAGE_WIDTH_TWO_INCH_SMALL_BOTTOM))
                            .append("\n");
                    PrinterTester.getInstance().printStr(String.valueOf(print_bill), null);
                    // PrinterTester.getInstance().printStr("GSTIN:"+"19AABCB0977F1ZP"+"\n",null);
                    // PrinterTester.getInstance().printStr("Download s-Parking from Play
                    // Store"+"\n",null);
                }
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                String[] arrLocName = breakStringToLines(
                        SharedStorage.getValue(OfflineCheckOutActivity.this, "parkinglocation"), 35);
    ...
    private void printEazytapBillNew() {
        try {
            ...
            // Set sixteenth line in Bitmap
            paint.setTextSize((int) (22));
            strText = "Managed by " + enterpriseNameOnly;
            paint.getTextBounds(strText, 0, strText.length(), bounds);
            x = (bitmap.getWidth() - bounds.width()) / 2;
            y += 24;
            canvas.drawText(strText, x, y, paint);
            ...
            result -> {
                if (result.getContents() == null) {
                    ...
                    if (originalIntent == null) {
                        ...
                        Toast.makeText(OfflineCheckOutActivity.this, "Cancelled due to missing camera permission",
                                Toast.LENGTH_LONG).show();
                    }
                } else {
                    Log.d("MainActivity", "Scanned");
                    Toast.makeText(OfflineCheckOutActivity.this, "Scanned: " + result.getContents(), Toast.LENGTH_LONG)
                            .show();
                    try {
                        if (result != null) {
