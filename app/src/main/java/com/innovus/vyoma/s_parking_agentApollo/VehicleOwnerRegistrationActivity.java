...
/* , SwipeListener */ {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String AgencyName = SharedStorage.getValue(this, "AgencyName");

        if (AgencyName != null && AgencyName.contains("|")) {
            String[] parts = AgencyName.split("\\|");
            // parts[1] matlab "|" ke baad wala naam
            enterpriseNameOnly = parts[1].trim();
        } else {
            // Agar "|" nahi mila toh purana wala naam default rahega
            enterpriseNameOnly = "Rohini Enterprise";
        }
        initviews();
    }
    ...
    private void initviews() {
        ...
        vehicleTypeListAdapter = new VehicleTypeListAdapter(VehicleOwnerRegistrationActivity.this,
                ...
                if (EDITTEXT_Mobile_Number_new.getText().toString().contains("X")) {
...

                    {
                        ...
                        if (dataModel.check_in == 0) {
                            ...
                            if (strName.equals("")) {
                                getRegisterAccess(SharedStorage.getValue(getApplicationContext(), "UserId"), "NA",
                                        strMobileNumber, strVehicleNumber, String.valueOf(iVehicleType));

                            } else {
                                if (isValid(strName)) {
                                    getRegisterAccess(SharedStorage.getValue(getApplicationContext(), "UserId"),
                                            strName, strMobileNumber, strVehicleNumber, String.valueOf(iVehicleType));
                    ...
                    if (isValidMobile(EDITTEXT_Mobile_Number_new.getText().toString().trim())) {
                        ...
                        if (isServerError == 1) {
                            ...
                            VehicleCheckInBean vehicleCheckInBean = new VehicleCheckInBean(strVehicleNumber,
                                    checkintime,
                            ...
                            if (SharedStorage.getValue(VehicleOwnerRegistrationActivity.this, "printer_name")
                                    .equals("")) {

                                final AlertDialog alertDialogoffline = new AlertDialog.Builder(
                                        VehicleOwnerRegistrationActivity.this).create();

                                final LayoutInflater inflater = VehicleOwnerRegistrationActivity.this
                                        .getLayoutInflater();
                                View dialogView = inflater.inflate(R.layout.customdialoglayout, null);
                            ...
                            } else if (SharedStorage.getValue(VehicleOwnerRegistrationActivity.this, "printer_name")
                                    .equals("eazy_Tap")) {
                            ...
                            if (dataModel.check_in == 0) {
                                ...
                                if (strName.equals("")) {
                                    ...
                                    if (isValid(strName)) {
                                        getRegisterAccess(SharedStorage.getValue(getApplicationContext(), "UserId"),
                                                strName, strMobileNumber, strVehicleNumber,
                                                String.valueOf(iVehicleType));

                                    } else {
                                        ShowAlertDialog.showAlertDialog(this,
                                                getResources().getString(R.string.vld_name));
                                    }
                                }
    ...
    private boolean validate() {
        boolean result = true;
        if (EDITTEXT_Mobile_Number_new.getText().toString().equals("")
                || EDITTEXT_Mobile_Number_new.getText().toString().length() != 10) {
            ShowAlertDialog.showAlertDialog(VehicleOwnerRegistrationActivity.this,
    ...
    private void getRegisterAccess(String agentId, String name, String mobile, String vehicle, String iVehicleType) {
        ...
        Urls Urls = new Urls();
        // String login_url = Urls.SetVehicleUserRegistration + "/" + name_replaced +
        // "/" + mobile + "/" + vechile + "/" + iVehicleType + "/NA";
        ...
        if (type.equals(RemoteAsync.NEWVEHICLEREGISTRATION)) {
            ...
            try {
                ...
                if (obj.getString("status").equals(Constants.SUCCESS)) {
                    ...
                    getRegisterAccess(SharedStorage.getValue(getApplicationContext(), "UserId"), strName,
                            strMobileNumber, strVehicleNumber, String.valueOf(iVehicleType));
            ...
            try {
                ...
                if (obj.getString("status").equals(Constants.SUCCESS)) {
                    ...
                    JSONObject msg = new JSONObject(output);
                    /* showMsg(msg.getString("message")); */
                    ShowAlertDialog.showAlertDialogFailure(VehicleOwnerRegistrationActivity.this,
                ...
                if (obj.getString("status").equals(Constants.SUCCESS)) {
                    ...
                    if (SharedStorage.getValue(VehicleOwnerRegistrationActivity.this, "printer_name").equals("")) {
                        ...
                        btnOk.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                alertDialog.dismiss();
                                Intent intent = new Intent(VehicleOwnerRegistrationActivity.this,
                    ...
                    bt_cancel.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            alertDialog.dismiss();
                            final AlertDialog alertDialogcancel = new AlertDialog.Builder(
                                    VehicleOwnerRegistrationActivity.this).create();

                            final LayoutInflater inflatercancel = VehicleOwnerRegistrationActivity.this
                                    .getLayoutInflater();
        ...
        try {
            ...
            if (pairedDevices.size() > 0) {
                for (BluetoothDevice device : pairedDevices) {
                    ...
                    if (device.getName()
                            .equals(SharedStorage.getValue(VehicleOwnerRegistrationActivity.this, "printer_name"))) {
    ...
    private void printEazytapBill() {
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                print_bill = new StringBuilder();
                print_bill.append(
                        paddingCenter(SharedStorage.getValue(VehicleOwnerRegistrationActivity.this, "parkinglocation"),
                                PAGE_WIDTH_TWO_INCH_SMALL))
                        .append("\n");
                PrinterTester.getInstance().printStr(String.valueOf(print_bill), null);
                ...
                PrinterTester.getInstance()
                        .printStr("Vehicle No    : " + m_EditTxtVehicleNumber.getText().toString() + "\n", null);
                ...
                PrinterTester.getInstance().leftIndents(Short.parseShort("10"));
                try {
                    String strVehicleNo = m_EditTxtVehicleNumber.getText().toString() + "##" + dateTime[0] + " "
                            + dateTime[1] + "##" + bookingNumber + "##" + String.valueOf(iVehicleType);
                    ...
                    try {
                        ...
                        if (bitmap != null) {
                            ...
                            print_bill = new StringBuilder();
                            print_bill.append(paddingCenter("Download s-Parking App from Play Store",
    ...
    private void printEazytapBillNew(String vehicle_number, String CheckinTime) {
        try {
            ...
            String[] arrLocName = breakStringToLines(
                    SharedStorage.getValue(VehicleOwnerRegistrationActivity.this, "parkinglocation"), 35);
            ...
            String strVehicleNo = vehicle_number + "##" + dateTime[0] + " " + dateTime[1] + "##" + bookingNumber + "##"
                    + String.valueOf(iVehicleType);
        ...
        new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    // Set seventh line in Bitmap
                    paint.setTextSize((int) (24));
                    strText = "Managed by " + enterpriseNameOnly; // Ab ye dynamic ho gaya
                ...
                // finally {
                // ShowAlertDialog.showAlertDialog(VehicleOwnerRegistrationActivity.this,"Unable
                // to print receipt");
                //
                // }
    ...
    private void printBillUsingPineLab(String checkinTime, String vehicle_number) {
        ...
        try {
            ...
            // header.put("ApplicationId", "8754f022bd7f475a9f29284a656d3401"); // Your
            ...
            emptyRow.put("PrintDataType", 0);
            emptyRow.put("PrinterWidth", 32);
            emptyRow.put("IsCenterAligned", true);
            emptyRow.put("DataToPrint", " ");
            printData.put(emptyRow);
