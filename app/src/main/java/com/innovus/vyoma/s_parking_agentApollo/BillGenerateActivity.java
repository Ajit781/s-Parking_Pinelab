...
public class BillGenerateActivity extends AppCompatActivity
        implements AsyncResponse, View.OnClickListener, FasTagListener/* , SwproipeListener */ {
    ...
    private TextView txt_vechile_no, txt_vechileType, txt_owner_phone_no, txt_check_in_time, txt_check_out_time,
            txt_owner_fee,
    ...
    private String bookingno = "", BookingID = "", checkintime = "", checkouttime = "", ownerphoneno = "",
            totalamount = "", ParkingAreaName = "", TotalDuration = "", TotalParkingAmount = "", TotalPaybleAmount = "",
            OfferAmount = "", FineAmount = "", PaymentMode = "", VehicleType = "", bookingstatus = "", vechile_no = "",
            message = "", AgencyName = "", agencyNameOnly = "", enterpriseNameOnly = "",
            overtime_duration = "", vehicle_type_icon = "", overtime_amount = "", bookingstatus_payment = "",
            paymentModeId = "", transactionId = "";
    ...
    private void initviews() {
        ...
        if (SharedStorage.getValue(BillGenerateActivity.this, "printer_name").equals("eazy_Tap")
                || (SharedStorage.getValue(BillGenerateActivity.this, "printer_name").equals("verifone"))) {
        ...
        // isPrint = 0;
        // paymentCollection(BookingID,"0");// here 0 denotes payment status Not
        // recieved
        //
        // }
        // });
            ...
            try {
                if (data != null && data.hasExtra("response")) {
                    if (resultCode == RESULT_OK) {
                        ...
                        // Payment is successful, you can record the transaction details like Ezetap
                        // transaction ID and complete the order
                    } else if (resultCode == RESULT_CANCELED) {
                        JSONObject response = new JSONObject(data.getStringExtra("response"));
                        response = response.getJSONObject("error");
                        String errorCode = response.getString("code");
                        ...
                        // Show the error to user as a pop-up informing the details so that he can take
                        // action against it.
                    } else {
            ...
            try {
                ...
                if (obj.getString("status").equals(Constants.SUCCESS)) {
                    ...
                    if (isPrint == 1) {
                        if (SharedStorage.getValue(BillGenerateActivity.this, "printer_name").equals("")) {
                        ...
                        } else if (SharedStorage.getValue(BillGenerateActivity.this, "printer_name")
                                .equals("eazy_Tap")) {
                            dataModel.about_advanced_dash = 1;
                            ...
                            // Intent intent = new Intent(BillGenerateActivity.this,
                            // VehicleInfoScanActivity.class);
                    ...
                    // dataModel.about_advanced_dash = 1;
                    // Intent intent = new
                    // Intent(BillGenerateActivity.this,DashBoardActivity.class);
                    // startActivity(intent);
    ...
    private void printEazytapBillNew() {
        ...
        try {
            ...
            String[] arrLocName = breakStringToLines(
                    SharedStorage.getValue(BillGenerateActivity.this, "parkinglocation"), 35);
            ...
            paint.setTextSize((int) (22));
            // strText =
            // SharedStorage.getValue(BillGenerateActivity.this,"parkinglocation");
        ...
        new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    print_bill.append(paddingCenter("Parking Maintenance Charge", PAGE_WIDTH_TWO_INCH_SMALL))
                            .append("\n");
                    PrinterTester.getInstance().printStr(String.valueOf(print_bill), null);
                    ...
                    // "+TotalParkingAmount+"\n",null);
                    // if (!overtime_duration.equals("0")){
                    // PrinterTester.getInstance().printStr("Overtime Amt : " + "Rs.
                    // "+FineAmount,null);
                    // }
                    //
                    ...
                    PrinterTester.getInstance()
                            .printStr("Pay " + PaymentMode + "    " + "Rs. " + TotalPaybleAmount + "\n", null);

                    PrinterTester.getInstance().fontSet(EFontTypeAscii.FONT_8_32, EFontTypeExtCode.FONT_16_16);
                    print_bill = new StringBuilder();
                    print_bill.append(paddingCenter("Inclusive of GST @ 18%", PAGE_WIDTH_TWO_INCH_SMALL_BOTTOM))
                            .append("\n");
                    print_bill.append(paddingCenter(agencyNameOnly, PAGE_WIDTH_TWO_INCH_SMALL_BOTTOM)).append("\n");
                    print_bill.append(
                            paddingCenter("GSTIN:" + SharedStorage.getValue(BillGenerateActivity.this, "AgencyGSTNo"),
                                    PAGE_WIDTH_TWO_INCH_SMALL_BOTTOM))
                            .append("\n");
                    print_bill
                            .append(paddingCenter("Managed by " + enterpriseNameOnly, PAGE_WIDTH_TWO_INCH_SMALL_BOTTOM))
                            .append("\n");
    ...
    private String[] getDateTime() {
        ...
        dateTime[0] = c.get(Calendar.DAY_OF_MONTH) + "/" + String.valueOf(c.get(Calendar.MONTH) + 1) + "/"
                + c.get(Calendar.YEAR);
    ...
    public void onClick(View view) {
        ...
        // btnOk.setClickable(true);
        // btnOk.setEnabled(true);
        // ShowAlertDialog.showAlertDialogFailure(this,
        ...
        //// SharedStorage.getValue(getApplicationContext(),"Userame"));
    ...
    private ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            map.put("ApplicationId", "8754f022bd7f475a9f29284a656d3401");
        ...
        try {
            ...
            for (String strLocName : arrLocName) {
                if (null != strLocName && !strLocName.trim().equals("")) {
                    ...
                    locObj.put("PrintDataType", 0);
                    locObj.put("PrinterWidth", 32);
                    locObj.put("IsCenterAligned", true);
                    locObj.put("DataToPrint", strLocName);
                    printData.put(locObj);
                }
            }
            ...
            printCheckin.put("IsCenterAligned", true);
            ...
            printCheckout.put("IsCenterAligned", true);
            printCheckout.put("DataToPrint", "CheckOut Time : " + checkouttime);
            ...
            if (!overtime_duration.equals("0")) {
                ...
                duration.put("IsCenterAligned", true);
                duration.put("DataToPrint", "Over Duration : " + overtime_duration);
                printData.put(duration);
            }

            JSONObject totalDur = new JSONObject();
            totalDur.put("PrintDataType", 0);
            totalDur.put("PrinterWidth", 32);
            totalDur.put("IsCenterAligned", true);
            totalDur.put("DataToPrint", "Duration : " + TotalDuration);
            printData.put(totalDur);
            ...
            SGST.put("IsCenterAligned", true);
            SGST.put("DataToPrint", "SGST @9% : Rs. " + sgst_calc);
            printData.put(SGST);

            String payStr = "Pay " + PaymentMode + " : Rs. " + TotalPaybleAmount;

            JSONObject payMode = new JSONObject();
            payMode.put("PrintDataType", 0);
            payMode.put("PrinterWidth", 32);
            payMode.put("IsCenterAligned", true);
            payMode.put("DataToPrint", payStr);
            printData.put(payMode);
            ...
            // Footer Agency Info
            JSONObject GSTNoObj = new JSONObject();
            GSTNoObj.put("PrintDataType", 0);
            GSTNoObj.put("PrinterWidth", 32);
            GSTNoObj.put("IsCenterAligned", true);
            GSTNoObj.put("DataToPrint", "GST No. " + gstNo);
            printData.put(GSTNoObj);
            ...
            companyName.put("DataToPrint", "Managed by " + enterpriseNameOnly);
            ...
            for (int i = 0; i < 2; i++) {
                ...
                emptyLine.put("PrintDataType", 0);
                emptyLine.put("PrinterWidth", 32);
                emptyLine.put("IsCenterAligned", true);
                emptyLine.put("DataToPrint", " "); // Blank space
                printData.put(emptyLine);
            }
            ...
            message.setData(data);
            message.replyTo = new Messenger(new BillGenerateActivity.IncomingHandlerPrint());
